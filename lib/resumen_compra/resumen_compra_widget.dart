...
class ResumenCompraWidget extends StatefulWidget {
  const ResumenCompraWidget({
    super.key,
    required this.oferta,
  });

  final OfertaRecord? oferta;

  static String routeName = 'resumenCompra';
  static String routePath = '/resumenCompra';

  @override
  State<ResumenCompraWidget> createState() => _ResumenCompraWidgetState();
}

class _ResumenCompraWidgetState extends State<ResumenCompraWidget> {
  late ResumenCompraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResumenCompraModel());
                                                          ...
                                                          return Row(
                                                            ...
                                                            children: [
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    '${producotsItem.cantidad.toString()} x ',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .labelMedium
                                                                        .override(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '\$${widget.oferta?.oferta.precioTotal.toString()}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                                      .override(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '\$${widget.oferta?.oferta.descuentoOS.toString()}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                                      .override(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              '\$${(widget.oferta!.oferta.precioTotal - widget.oferta!.oferta.descuentoOS).toString()}',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .titleLarge
                                                  .override(
                                      ...
                                      await CompraRecord.collection
                                          ...
                                          .set(createCompraRecordData(
                                            compra: createCompraStruct(
                                              receta: _model
                                                  .ordenUid?.orden.receta,
                                              obraSocial: valueOrDefault(
                                                  currentUserDocument
                                                      ?.nombreObraSocial,
                                                  ''),
                                              observaciones: _model.ordenUid
                                                  ?.orden.observaciones,
