...
class _EditarPerfilWidgetState extends State<EditarPerfilWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault(currentUserDocument?.nombreObraSocial, '') ==
          'No tengo') {
        safeSetState(() {
          _model.obraSocialValueController?.value = 'No tengo';
        });
        safeSetState(() {});
      }
    });
    ...
    _model.domicilioTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.domicilio, ''));
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => TextFormField(
                                          controller:
                                              _model.domicilioTextController,
                                                ...
                                                children: [
                                                  Align(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      child: Text(
                                                        'Toque aquí para cambiar foto del carnet',
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                            FlutterFlowTheme.of(
