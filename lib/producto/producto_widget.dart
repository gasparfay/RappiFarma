...
class _ProductoWidgetState extends State<ProductoWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductoRecord>(
      stream: ProductoRecord.getDocument(widget.productRef!),
      builder: (context, snapshot) {
        ...
        final productoProductoRecord = snapshot.data!;
          ...
          appBar: AppBar(
            ...
            actions: [
              Padding(
                ...
                child: badges.Badge(
                  badgeContent: Text(
                    FFAppState().cantCarrito.toString(),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            valueOrDefault<String>(
                              productoProductoRecord.descripcion,
                              'NN',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
