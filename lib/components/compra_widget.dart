            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Compra N°${((widget.index!) + 1).toString()}',
                    ...
                    Text(
                      'Obra social: ${widget.compra?.compra.obraSocial}',
                    ...
                    Text(
                      'Observaciones:${widget.compra?.compra.observaciones}',
                      style: FlutterFlowTheme.of(context).bodySmall.override(
                            font: GoogleFonts.inter(
                              fontWeight: FlutterFlowTheme.of(context)
                                  .bodySmall
                    ...
                    Text(
                      'Dirección: ${widget.compra?.compra.direccion}',
                      style: FlutterFlowTheme.of(context).bodySmall.override(
                            font: GoogleFonts.inter(
                              fontWeight: FlutterFlowTheme.of(context)
                                  .bodySmall
                    ...
                    Text(
                      'Fecha: ${dateTimeFormat(
                        ...
                        DateTime.fromMillisecondsSinceEpoch(valueOrDefault<int>(
                          widget.compra?.compra.tiempoInicio
                    ...
                    Builder(
                      builder: (context) {
                        final producots =
                            widget.compra?.compra.productos.toList() ?? [];

                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: producots.length,
                          itemBuilder: (context, producotsIndex) {
                            final producotsItem = producots[producotsIndex];
                            return Row(
                    ...
                    builder: (context) {
                      return Padding(
                        ...
                        child: RecetaOrdenWidget(
                          foto: widget.compra?.compra.receta,
                        ),
                      );
                    },
