...
class _ConfirmarOrdenWidgetState extends State<ConfirmarOrdenWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().productos =
          functions.eliminarLista().toList().cast<ProductoStruct>();
      safeSetState(() {});
      FFAppState().addToProductos(ProductoStruct(
        nombre: '',
        precio: 0.0,
        cantidad: 1,
      ));
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowCountController(
                                ...
                                count: _model.cantProductosValue ??= 1,
                                updateCount: (count) async {
                                  safeSetState(
                                      () => _model.cantProductosValue = count);
                                  if (FFAppState().productos.length <
                                      _model.cantProductosValue!) {
                                    FFAppState().addToProductos(ProductoStruct(
                                      nombre: '',
                                      precio: 0.0,
                                      cantidad: 1,
                                    ...
                                    FFAppState().removeFromProductos(
                                        FFAppState().productos.lastOrNull!);
                                    safeSetState(() {});
                                  }
                                },
                                stepSize: 1,
                              ...
                              itemBuilder: (context, prodsIndex) {
                                ...
                                return Container(
                                  ...
                                  child: ProductoWidget(
                                    key: Key(
                                        'Keylr3_${prodsIndex}_of_${prods.length}'),
                                    index: prodsIndex,
                                  ),
                                );
                              },
