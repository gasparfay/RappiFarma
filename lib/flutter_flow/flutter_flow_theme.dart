...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFFFFCC99);
  late Color primaryText = const Color(0xFFFF6600);
  ...
  late Color accent2 = const Color(0xFFFFCC00);
  late Color accent3 = const Color(0xFFFF3366);
  late Color accent4 = const Color(0xFF66CCFF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD85B00);
  late Color secondary = const Color(0xFFA4A4A4);
  late Color tertiary = const Color(0xFFF0F0F0);
  late Color alternate = const Color(0xFFE6B89D);
  late Color primaryText = const Color(0xFFFF6600);
  ...
  late Color accent1 = const Color(0xFFCC7A00);
  late Color accent2 = const Color(0xFFD9A300);
  late Color accent3 = const Color(0xFFCC0052);
  late Color accent4 = const Color(0xFF0099CC);
